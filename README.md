About pyiron-experimental-feedstock
===================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pyiron-experimental-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pyiron-experimental-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pyiron-experimental
# for installing globally
pixi global install pyiron-experimental
```
...
It is possible to list all of the versions of `pyiron-experimental` available on your platform:
...
```
pixi search pyiron-experimental --channel conda-forge
```
